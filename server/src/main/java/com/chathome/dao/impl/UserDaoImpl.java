package com.chathome.dao.impl;

import com.chathome.dao.UserDao;
import com.chathome.entity.User;
import com.chathome.util.JDBCUtils;
...
public class UserDaoImpl implements UserDao {
    ...
    public int save(User user) {
        //sql语句int
        String sql="insert into user(email,password,username) value(?,?,?)";
        //执行sql
        int update = template.update(sql, user.getEmail(), user.getPassword(),user.getUsername());
       return update;
    }
